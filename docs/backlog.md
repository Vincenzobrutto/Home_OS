...
|---|---|---|---|
| B1 | Ampliare i test automatici backend (unit + e2e) — prima copertura reale aggiunta per stato/garanzia Asset e regole principali della pipeline documentale (8 test totali inclusa la suite scaffold) | Alta | proseguire con error handling di `analyze`, rami creazione multipla/house-level e test e2e API |
