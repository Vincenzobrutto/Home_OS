...
export const api = {
  ...
  houses: {
    ...
    create: (data: { name: string; region: string; city?: string; surfaceSqm?: number; roomsCount?: number; buildYear?: number }) => request<House>('/houses', { method: 'POST', body: JSON.stringify(data) }),
